 ...
 */
export default function NoSplitAlternatives({ alternatives, containerCount }) {
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 11, color: theme.textMuted, marginTop: 2 }}>
            These voyages can carry all {containerCount} containers together — minimising journeys
          </div>
        </div>
        <span
          style={{
      ...
      {alternatives.map((alt, i) => (
        <div
          ...
          style={{
            ...
            background: i % 2 === 0 ? theme.bgSecondary : theme.bgPrimary,
          }}
        >
          {alt.type === "direct" ? (
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      ...
      <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <StatusPill status={isLate ? "late" : "ok"}>
          {isLate ? "LATE" : "ON TIME"}
        </StatusPill>
        <span
          style={{
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <span style={{ fontSize: 11, color: theme.textSecondary }}>{port(leg1.portFrom)} → ROTTE</span>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <span style={{ fontSize: 11, color: theme.textSecondary }}>ROTTE → {port(leg2.portTo)}</span>
